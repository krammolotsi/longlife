function Layout() {
  return (
    <div className="bg-blue-light">
      {/* side menu */}
      <div className="py-12 px-10 w-1/4 bg-white md:min-h-full-screen">
        ...
        <div className="flex space-2 items-center border-b-2 pb-4">
          ...
          <div className="ml-3">
            <h1 className="text-3xl font-bold text-sky-700">VENUS</h1>
            <p className="text-center text-sm text-sky-700 mt-1 font-serif">
              DASHBOARD
            </p>
          </div>
        </div>
        {/* side menu dashboard */}
        <div className="flex items-center space-x-4 mt-6 p-2 bg-sky-700 rounded-md">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mt-8">
          <ul className="space-y-10">
            <li>
              <a
                href="#"
                className="flex items-center text-sm font-semibold text-gray-500 hover:text-sky-700 transition duration-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 mr-4 text-gray-400 hover:text-sky-700 transition duration-200"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
            ...
            <li>
              <a
                href="#"
                className="flex items-centerx text-sm font-semibold text-gray-500 hover:text-sky-700 transition duration-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 mr-4 text-gray-400 hover:text-sky-700 transition duration-200"
        ...
        <div className="flex mt-20 space-x-4 items-center">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 text-gray-400 hover:text-sky-700 transition duration-200"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <a
            href="#"
            className="block font-semibold text-gray-500 hover:text-sky-700 transition duration-200"
          >
            Logout
          </a>
        </div>
      ...
      {/* <div className="bg-indigo-50 flex-grow py-12 px-10">
        <div className="flex justify-between">
          <div>
            <h4 className="text-sm font-bold text-sky-700">Hi Andrei,</h4>
